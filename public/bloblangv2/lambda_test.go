...
// lambda support, which has no V1 stdlib equivalent. The function takes
// a count and a producer lambda; the lambda is invoked count times with
// its index and the results are collected.
