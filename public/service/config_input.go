...
// TimelyNacksFieldName is the configuration field name for enabling a forced
// timely acknowledgement for messages based on a specified maximum wait period.
const TimelyNacksFieldName = "timely_nacks_maximum_wait"

// NewTimelyNacksField creates a configuration field for enabling a forced
...
// configuration.
func NewTimelyNacksField() *ConfigField {
	return NewDurationField(TimelyNacksFieldName).
