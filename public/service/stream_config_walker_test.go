...
`, env)
	...
	expected := map[string][2]string{
		"input":                                [2]string{"", "meow"},
		"input.meow.li.0":                      [2]string{"d", "generate"},
		"input.meow.li.1":                      [2]string{"e", "generate"},
		"input.meow.mi.foo":                    [2]string{"", "dynamic"},
		"input.meow.mi.foo.dynamic.inputs.qev": [2]string{"", "generate"},
		"input.meow.mi.foo.dynamic.inputs.qux": [2]string{"", "generate"},
		"input.meow.si":                        [2]string{"a", "generate"},
		"input.meow.si.processors.0":           [2]string{"b", "compress"},
		"input.meow.si.processors.1":           [2]string{"c", "compress"},
	}
