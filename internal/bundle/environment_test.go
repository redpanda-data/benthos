...
func TestEnvironmentWithout(t *testing.T) {
	...
	env = env.Without("barbuffer", "barcache", "barinput", "baroutput", "barprocessor", "barratelimit", "barmetric", "bartracer", "barscanner")
...
func TestEnvironmentIndividualWithout(t *testing.T) {
	env := bundle.NewEnvironment()
	...
	env = env.WithoutBuffers("barbuffer")
	env = env.WithoutCaches("barcache")
	env = env.WithoutInputs("barinput")
	env = env.WithoutOutputs("baroutput")
	env = env.WithoutProcessors("barprocessor")
	env = env.WithoutRateLimits("barratelimit")
	env = env.WithoutMetrics("barmetric")
	env = env.WithoutTracers("bartracer")
	env = env.WithoutScanners("barscanner")
...
func TestEnvironmentWith(t *testing.T) {
	env := bundle.NewEnvironment()
	...
	env = env.With("barbuffer", "barcache", "barinput", "baroutput", "barprocessor", "barratelimit", "barmetric", "bartracer", "barscanner")
