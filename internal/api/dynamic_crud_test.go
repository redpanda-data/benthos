...
func TestDynamicDelete(t *testing.T) {
	...
	dAPI.OnDelete(func(_ context.Context, id string) error {
		if failRemove {
	...
	dAPI.OnUpdate(func(context.Context, string, []byte) error {
...
func TestDynamicBasicCRUD(t *testing.T) {
	...
	var updateErr error
	dAPI.OnUpdate(func(_ context.Context, _ string, content []byte) error {
...
func TestDynamicListing(t *testing.T) {
	...
	dAPI.OnDelete(func(context.Context, string) error {
		return nil
	})
